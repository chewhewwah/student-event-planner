                    ...
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <form id="contactForm" action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                                    ...
                                    <div class="form-outline form-white mb-3">
                                        <input type="currpassword" id="currpassword" name="currpassword" class="form-control form-control-lg" />
                                        <label class="form-label" for="password">Current Password</label>
                                    </div>

                                    <div class="form-outline form-white mb-3">
                                        <input type="newpassword" id="newpassword" name="newpassword" class="form-control form-control-lg" />
                                        <label class="form-label" for="password">New Password</label>
                                    </div>

                                    <div class="form-outline form-white mb-3">
                                        <input type="conpassword" id="conpassword" name="conpassword" class="form-control form-control-lg" />
                                ...
                                if( $_POST["conpassword"] === $_POST["newpassword"] ){
                                    if(isset($_POST['currpassword'])) {
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            <?php
                                            //echo "Error: " . $sql . "<br>" . $conn->error;
                                            //ask Dr.Chin if this is possible
                                        }
                                    }
                                    else{
                                        ?>
                                        <p>You need to provide proper email address.</p>
                                        <?php
                                    }
                                }
                                else{
                                    ?>
                                        <p>New Password is not the same as Confirm Password.</p>
                                        <?php
                                }
                                ?>
                            <?php endif ?>
