        ...
        <div class="row d-flex justify-content-center align-items-start h-100">
            <div class="card-body p-5 text-center">
                <div class="mb-md-5 mt-md-4 pb-5">
                    <h2 class="fw-bold mb-2 text-uppercase" align="center">Current Event Lists</h2><br>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-outline-light btn-sm px-2" href="<?php echo $roothtml?>/editevent.php?eventId=<?php echo $row['eventId']?>">Edit Event</a>&nbsp;&nbsp;<a class="btn btn-outline-light btn-sm px-2" href="<?php echo $roothtml?>/historyevent.php?eventId=<?php echo $row['eventId']?>">Delete Event</a>
                                    </tr>
                                <?php 
                                }
                             }
